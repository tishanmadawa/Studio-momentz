    ...
    <div class="col-md-12">
        ...
        <div class="box">
            ...
            <table class="table table-bordered table-inverse" style="background-color: #A2B9B4;">
                <tr><th> Package</th><th> Price </th><th> No of Photoes </th><th> No of Camera men </th><th> Flashes </th><th> Video Hours< </th><th> Update </th><th> Delete </th></tr>
                ...
                <?php foreach($table as $key => $row){?>
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo site_url('Controller/loadedit/'.$row['Package'].''); ?>"  style="color:#fff"> Edit </a></td>
                            <td><a href="<?php echo site_url('Controller/delete/'.$row['Package'].''); ?>" style="color:#fff"> Delete </a></td>
                        </tr>
                <?php }?>
